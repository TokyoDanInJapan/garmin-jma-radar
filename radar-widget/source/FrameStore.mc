...
// (see put()). ~1/3 of the ~1MB heap comfortably covers serialising one decoded
...
// anyway (makeImageRequest returns an already-decoded bitmap, and
// makeWebRequest has
...
//     firmware a stored bitmap is loaded/serialised in the ~1MB app heap (not the
